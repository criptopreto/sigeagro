...
class EmployeesActivesFijosScreen extends StatelessWidget {
  final String searchValue;

  const EmployeesActivesFijosScreen({super.key, required this.searchValue});
        ...
        body: StreamBuilder<List<Employee>>(
          stream: employeeDataInstance.employeeCollection.snapshots().map(
                (querySnapshot) => querySnapshot.docs
                    ...
                    .where((employee) =>
                        employee.tipo != null && employee.tipo == "fijo")
                    .where((employee) =>
                        employee.nombres
                            .toLowerCase()
