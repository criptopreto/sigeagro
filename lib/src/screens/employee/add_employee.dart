...
class _AddEmployeeState extends State<AddEmployee> {
  ...
  final TextEditingController nombresConstroller = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        hasChanges |= nombresConstroller.text.isNotEmpty;
  ...
  Future<void> _saveEmployee() async {
    ...
    try {
      ...
      final employeeData = {
        ...
        "nombres": nombresConstroller.text,
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text('Empleado agregado exitosamente.'),
            actions: <Widget>[
              TextButton(
                onPressed: () {
